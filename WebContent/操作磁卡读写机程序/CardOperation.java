...
public class CardOperation {      
     ...
     * @param args  
     */   
    public int open_Machine(int port) throws Exception {   
   ...
   public int close_Machine() throws Exception {   
       JNative jnative = null;   
        try {   
    ...
    public String read_Machine(int TrackNo) throws Exception {   
        JNative jnative = null;   
        try {   
    ...
    public int write_Machine(int TrackNo, String content) throws Exception {   
        JNative jnative = null;   
       try {   
