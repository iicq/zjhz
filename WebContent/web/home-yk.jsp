...
<!DOCTYPE html PUBLIC "-//W3C//DTD HTML 4.01 Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
	...
	<div class="tabbable tabbable-custom boxless">
		...
		<ul class="nav nav-tabs" id="tabTitle" style="background-color: #E9E9E9;border-bottom: 1px solid #B8B8B8;">
			...
			<li class="dropdown user tab-title-class" id="nav-tab-4">
				<a href="#" class="dropdown-toggle" data-toggle="dropdown" ><span>方案</span></a>
			...
			<li class="dropdown user tab-title-class visible-desktop"  id="nav-tab-10">
				<a href="javascript:void(0)" onclick="Ranging();">测距</a>
			</li>
			
			<li class="dropdown user tab-title-class "  id="nav-tab-22">
				<a href="javascript:void(0)" onclick="MyUpload();">自定义上传</a>
			</li> 
			
			<li class="dropdown user tab-title-class" id="nav-tab-11">
				<span id="Span1" style="margin-left: 30px;display:none" >点击地图可跟踪您要测量的路线.&nbsp;&nbsp;&nbsp;距离：
				 		<span id="sRes">0.000</span>km 
				 		<button class="btn" type="button"  onclick="deleteOverlays();">清除标记</button>
					 	<button class="btn" type="button"  onclick="removeOverlays();">取&nbsp;消</button>
				</span>
			</li>
			...
			<li class="dropdown user tab-title-class visible-desktop pull-right"  id="nav-tab-18" style="margin-left: 10px;">
				<a href="javascript:void(0)" onclick="closeInfoWindow();infoContents = {};"> 
			...
			<li class="dropdown user tab-title-class visible-desktop pull-right"  id="nav-tab-22" style="margin-top: 5px;margin-left: 20px;">
				
				<label for="nav-tab-22-checkbox" style="display: inline;font-size: 12px;" >
						<input id="nav-tab-22-checkbox" type="checkbox" style="vertical-align: -3px;" onchange="openInfoWindow(this);">
						大头针
				</label>
				
			</li>
			
			<li class="dropdown user tab-title-class visible-desktop pull-right"  id="nav-tab-21" style="margin-top: 5px;">
				
				<label for="nav-tab-21-checkbox" style="display: inline;font-size: 12px;" >
						<input id="nav-tab-21-checkbox" type="checkbox" style="vertical-align: -3px;" onchange="showOldIndexMap(this);">
						全部媒体
				</label>
				
			</li>
			
			<li class="dropdown user tab-title-class  pull-right"  id="nav-tab-21" style="margin-top: 5px;">
				
				<label for="nav-tab-21-checkbox" style="display: inline;font-size: 12px;" >
					<a href="/login.jsp" style="margin-right: 20px">登录</a>
				</label>
		...
		<div class="tab-content" id="tabContent"  style="padding-top: 0px;">
			<div class="tab-content-class tab-pane active" id="portlet_tab1">
				<s:include value="home1.jsp"></s:include>
			</div>
